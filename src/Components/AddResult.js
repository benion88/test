...
const AddResult = () => {
 ...
 const [school_section, setSchoolSection] = useState("");
 ...
 const [isParent, setIsParent] = useState(false);
  ...
  const SubmitResult = (e) => {
    ...
    if (authToken) {
      ...
      fetch("https://sms-penetralia.azurewebsites.net/api/exam_result/create", {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify(request),
          ...
          setMessage("Well done! You successfully create student result.");
        }).catch(() => {
          setError(
            "Error! Data could not be added, try again, avoid duplicate record  "
          );
        });
    }
  };
   ...
   const ReSet = () => {
    ...
    const isFormValid = () => {
     ...
     const handleTeacherEmailInputChange = (e) => {
       const enteredValue = e.target.value;
       setTeacherEmail(enteredValue);
       if (!isValidEmail(enteredValue)) {
         setEmailError2("Not a valid email");
       } else {
         setEmailError2("");
       }
     };
              ...
              <div class="col-4-xxxl col-12">
                <div class="card height-auto">
                  <div class="card-body">
                    ...
                    <form class="new-added-form" onSubmit={SubmitResult}>
                      <div class="row">
                        ...
                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                          ...
                          <input
                            ...
                            class="form-control"
                            onChange={(e) => {
                              setPercentageUpto(e.target.value);
                            }}
                          />
                        </div>
                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                        ...
                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                          ...
                          <input
                            ...
                            class="form-control"
                            onChange={(e) => {
                              setSchoolSection(e.target.value);
                            }}
                          />
                        </div>
                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                        ...
                        <div className="col-xl-3 col-lg-6 col-12 form-group">
                          ...
                          <input
                            ...
                            className="form-control"
                            value={teacher_email}
                            onChange={handleTeacherEmailInputChange}
                          />
                          {emailError2 && (
                            <p style={{ color: "red" }}>{emailError2}</p>
                          )}
                        </div>
                        <div className="col-xl-3 col-lg-6 col-12 form-group">
