...
const ExamGrade = () => {
    ...
    const [grade_point, setGradePoint] = useState("");
    const [percentage_from, setPercentageFrom] = useState("");
    const [percentage_upto, setPercentageUpto] = useState("");
    ...
    const SubMiteGrade = (e) =>{
        e.preventDefault()

  const grade = {grade_name,grade_point,percentage_from,percentage_upto,comment};
  const request = {
   'meta': {
    'action': '0',
    'source': 'web'
  ...
  if (authToken) {
   ...
   fetch(
    'https://sms-penetralia.azurewebsites.net/api/exam_grade/exam_grade_form',
    {
     method: 'POST',
     headers: {
    ...
    .then(() => {
     setMessage('Well done! You successfully submitted a new Exam grade.');
    })
    .catch(() => {
     setError('Error! Data could not be added, try again, avoid duplicate Exam grade  ');
    });
  }
 ...
 useEffect(() => {
  ...
  if (authToken) {
   ...
   fetch('https://sms-penetralia.azurewebsites.net/api/exam_grade/exam_grade_list', {
    method: 'GET',
    headers: {
     'Content-Type': 'application/json',
     'Accept': 'application/json',
 ...
 const handleSearch = (event) => {
  ...
  const searchUrl = new URL('https://sms-penetralia.azurewebsites.net/api/exam_grade/search');
 ...
 const deleteUser = async (id) => {
  ...
  try {
   ...
   try {
    ...
    const response = await fetch(`https://sms-penetralia.azurewebsites.net/api/exam_grade/delete/${id}`, {
     method: 'DELETE',
     headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
 ...
 const isFormValid = () => {
   return (
     grade_name.trim() !== "" &&
     grade_point.trim() !== "" &&
     percentage_from.trim() !== "" &&
     percentage_upto.trim() !== ""
   );
 };
              ...
              <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                ...
                >
                  ...
                  <ul class="nav sub-group-menu">
                    ...
                    <li class="nav-item">
                      <a href="/exam-grade" class="nav-link menu-active">
              ...
              <div className="col-4-xxxl col-12">
                <div className="card height-auto">
                  <div className="card-body">
                    ...
                    <form className="new-added-form" onSubmit={SubMiteGrade}>
                      <div className="row">
                        ...
                        <div className="col-12-xxxl col-lg-6 col-12 form-group">
                          ...
                          <input
                            ...
                            placeholder=""
                            className="form-control"
                            onChange={(e) => setPercentageUpto(e.target.value)}
                          />
                        </div>
                                ...
                                <td>
                                  <div class="form-check">
                                    ...
                                    <label class="form-check-label">
                                      {filteredGrades.grade_name}
                                    </label>
                                  </div>
                                </td>
                                <td>{filteredGrades.grade_point}</td>
                                <td>{filteredGrades.percentage_from}</td>
                                <td>{filteredGrades.percentage_upto}</td>
                                <td>{filteredGrades.comment}</td>
                  ...
                  <i class="fas fa-cogs text-dark-pastel-green"></i>
                            ...
                            grades.map((grade) => (
                              <tr key={grade.id}>
                                ...
                                <td>{grade.percentage_from}</td>
                                <td>{grade.percentage_upto}</td>
                                <td>{grade.comment}</td>
