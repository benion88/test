...
const Transport = () => {
 ...
 const SubmitTransport = (e) =>{
  e.preventDefault();
  const transport = {route_name,vehicle_number,driver_name,license_number,phone_number};
  ...
  if (authToken) {
   ...
   fetch(
    'https://sms-penetralia.azurewebsites.net/api/transport/transport_form',
    {
     method: 'POST',
     headers: {
    ...
    .then(() => {
     setMessage('Well done! You successfully submitted a transport.');
    })
    .catch(() => {
     setError('Error! Data could not be added, try again, avoid duplicate transport');
    });
 ...
 useEffect(() => {
  ...
  if (authToken) {
   ...
   fetch('https://sms-penetralia.azurewebsites.net/api/transport/transport_list', {
    method: 'GET',
    headers: {
     'Content-Type': 'application/json',
     'Accept': 'application/json',
 ...
 const handleSearch = (event) => {
  ...
  const searchUrl = new URL('https://sms-penetralia.azurewebsites.net/api/transport/search');
  ...
  fetch(searchUrl, {
   ...
   .then(result => {
    ...
    if (result && result.data) {
     setFilteredTransports(result.data);
         ...
         <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
           ...
           {/* <div class="sidebar-menu-content">
             <ul class="nav nav-sidebar-menu sidebar-toggle-view">
               ...
               <li class="nav-item" style={{ backgroundColor: "black" }}>
                 <a href="/transport" class="nav-link menu-active">
             ...
             <div class="col-4-xxxl col-12">
               <div class="card height-auto">
                 <div class="card-body">
                   ...
                   <form class="new-added-form" onSubmit={SubmitTransport}>
                     <div class="row">
                       ...
                       <tbody>
                         {searchActive ? (
                           ...
                           filteredTransports ? (
                             <tr
                               onClick={() =>
                                 navigate(`//${filteredTransports.id}`)
                               }
                             ...
                             >
                               <td>
                                 <div class="form-check">
                                   ...
                                   />
                                   <label class="form-check-label">
                                     {filteredTransports.route_name}
                                   </label>
                                 </div>
                               </td>
                               <td>{filteredTransports.vehicle_number}</td>
                               <td>{filteredTransports.driver_name}</td>
                               <td>{filteredTransports.license_number}</td>
                               <td>{filteredTransports.phone_number}</td>
                               <td>
                                 <div class="dropdown">
                                   <a
                                     href="/#"
                           ...
                           <tr>
                             <td
                               ...
                               style={{ textAlign: "center", color: "green" }}
                             >
                               No transports record available
                             </td>
                           </tr>
                         )}
