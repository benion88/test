...
const AllExpense = () => {
 ...
 useEffect(() => {
  ...
  if (authToken) {
   ...
   fetch('https://sms-penetralia.azurewebsites.net/api/account/account_expense_list', {
    method: 'GET',
    headers: {
 ...
 const handleSearch = (event) => {
  ...
  const searchUrl = new URL('https://sms-penetralia.azurewebsites.net/api/account/expense_search');
 ...
 const deleteExpense = async (id) => {
  ...
  try {
   ...
   try {
    ...
    const response = await fetch(`https://sms-penetralia.azurewebsites.net/api/account/expense/delete/${id}`, {
     method: 'DELETE',
     headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
             ...
             <ul class="nav nav-sidebar-menu sidebar-toggle-view">
               ...
               >
                 ...
                 <ul class="nav sub-group-menu sub-group-active">
                   ...
                   <li class="nav-item">
                     <a href="/allExpense" class="nav-link menu-active">
                     ...
                     {searchActive ? (
                       ...
                       filteredExpenses ? (
                         <tr style={{ cursor: "pointer" }}>
                           ...
                           <td>
                             {filteredExpenses.first_name}{" "}
                             {filteredExpenses.last_name}
                           </td>
                           <td>{filteredExpenses.expense_type}</td>
                           <td>{filteredExpenses.amount}</td>
                           <td
                             className={`badge badge-pill ${
                               filteredExpenses.status === "paid"
                                 ? "badge-success"
                                 : "badge-danger"
                             } d-block mg-t-8`}
                           >
                           ...
                           <td>{filteredExpenses.phone}</td>
                           <td>{filteredExpenses.email}</td>
                             ...
                             <div class="dropdown">
                               ...
                               <div class="dropdown-menu dropdown-menu-right">
                                 <div
                                   class="dropdown-item"
                                   onClick={() =>
                                     deleteExpense(filteredExpenses.id)
                                   }
                                 >
                       ...
                       expenses.map((expense) => (
                         <tr key={expense.id} style={{ cursor: "pointer" }}>
                           <td>
                             <div class="form-check">
                               <input
                                 type="checkbox"
