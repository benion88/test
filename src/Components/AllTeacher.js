...
const AllTeacher = () => {
  ...
  useEffect(() => {
    ...
    if (authToken) {
      ...
      fetch(
        "https://sms-penetralia.azurewebsites.net/api/teacher/teacher_list",
        {
          method: "GET",
          headers: {
  ...
  const handleSearch = (event) => {
    ...
    const searchUrl = new URL(
      "https://sms-penetralia.azurewebsites.net/api/teacher/search"
    );
    ...
    try {
      ...
      try {
        ...
        const response = await fetch(
          `https://sms-penetralia.azurewebsites.net/api/teacher/delete/${id}`,
          {
            method: "DELETE",
            headers: {
              "Content-Type": "application/json",
              ...
              <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                ...
                >
                  ...
                  <ul class="nav sub-group-menu sub-group-active">
                    <li class="nav-item">
                      <a href="/allTeacher" class="nav-link menu-active">
                      ...
                      {searchActive ? (
                        ...
                        filteredTeachers ? (
                          <tr>
                            ...
                            <td>
                              {filteredTeachers.first_name}{" "}
                              {filteredTeachers.last_name}
                            </td>
                            <td>{filteredTeachers.gender}</td>
                            <td>{filteredTeachers.class_room}</td>
                            {/* <td>{ filteredTeachers.subject}</td> */}
                            <td>{filteredTeachers.section}</td>
                            <td>{filteredTeachers.address}</td>
                            <td>{filteredTeachers.phone}</td>
                            <td>{filteredTeachers.email}</td>
                            <td>{filteredTeachers.religion}</td>
                            <td>{filteredTeachers.date_of_birth}</td>
                            <td>{filteredTeachers.joining_date}</td>
                            <td>
                              <div class="dropdown">
                                <a
                                  href="/#"
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                  <div
                                    class="dropdown-item"
                                    onClick={() =>
                                      deleteTeacher(filteredTeachers.id)
                                    }
                                  >
                                  ...
                                  <a
                                    class="dropdown-item"
                                    href={`/edit-teacherr/${filteredTeachers.id}`}
                                  >
                        ...
                        teachers.map((teacher) => (
                          <tr
                            key={teacher.id}
                            onClick={() =>
                              navigate(`/teacherDetails/${teacher.id}`)
                            }
