...
const AddBook = () => {
  ...
  const [writter_name, setWritterName] = useState("");
  ...
  const SubmitBook = (e) => {
    ...
    if (authToken) {
      ...
      fetch(
        "https://sms-penetralia.azurewebsites.net/api/library/library_form",
        {
          method: "POST",
          headers: {
              ...
              <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                ...
                >
                  ...
                  <ul class="nav sub-group-menu sub-group-active">
                    ...
                    <li class="nav-item">
                      <a href="/addBook" class="nav-link menu-active">
          ...
          <div class="dashboard-content-one">
            ...
            <div class="card height-auto">
              <div class="card-body">
                ...
                <form class="new-added-form" onSubmit={SubmitBook}>
                  <div class="row">
                    ...
                    <div className="col-xl-3 col-lg-6 col-12 form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          setPublishingDate(formattedDate);
                        }}
                      />
                    </div>
                    <div className="col-xl-3 col-lg-6 col-12 form-group">
