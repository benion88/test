 ...
 useEffect(() => {
   const fetchData = async () => {
     try {
       ...
       if (authToken) {
         ...
         const response = await fetch(
           `https://sms-penetralia.azurewebsites.net/api/student/student-detail/${studentId}`,
           {
             method: "GET",
             headers: {
               "Content-Type": "application/json",
  ...
  useEffect(() => {
    if (student) {
      ...
      setClassRoom(student.class_name || "");
      setSection(student.section || "");
      setAdmissionDate(student.admission_date || "");
      setPhone(student.phone || "");
      setAddress(student.address || "");
      setImage(student.image || "");
      setShortBio(student.short_bio || "");
   ...
   const EditStudent = async (e) => {
     ...
     try {
       ...
       try {
         ...
         const response = await fetch(
           `https://sms-penetralia.azurewebsites.net/api/student/update/${studentId}`,
           {
             method: "PUT",
             headers: {
               "Content-Type": "application/json",
         ...
         if (!response.ok) {
           ...
           setMessage(
             `User with ID ${studentId} has been updated successfully.`
           );
