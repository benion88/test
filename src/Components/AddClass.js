...
const AddClass = () => {
  const [teacher_full_name, setTeacherFullName] = useState("");
 ...
 const [isParent, setIsParent] = useState(false);
  ...
  const SubmitClass = (e) => {
    ...
    if (authToken) {
      ...
      fetch("https://sms-penetralia.azurewebsites.net/api/class/class_form", {
        method: "POST",
        headers: {
        ...
        .then(() => {
          setMessage("Well done! You successfully submitted a new book.");
        })
        .catch(() => {
          setError(
            "Error! Data could not be added, try again, avoid duplicate book  "
          );
        });
    }
  };
              ...
              <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                ...
                >
                  ...
                  <ul class="nav sub-group-menu sub-group-active">
                    ...
                    <li class="nav-item">
                      <a href="/addClass" class="nav-link menu-active">
          ...
          <div class="dashboard-content-one">
            ...
            <div class="card height-auto">
              <div class="card-body">
                ...
                <form class="new-added-form" onSubmit={SubmitClass}>
                  <div class="row">
