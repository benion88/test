...
const Notice = () => {
 ...
 const[notice_time,setNoticeTime] = useState('');
 ...
 const SubmitNotice = (e) =>{
  e.preventDefault();
  const notice = {notice_time,details,posted_by,posted_date,class_name};
  console.log(notice);
  ...
  if (authToken) {
   ...
   fetch(
    'https://sms-penetralia.azurewebsites.net/api/notice/notice_form',
    {
     method: 'POST',
     headers: {
    ...
    .then(() => {
     setMessage('Well done! You successfully submitted a new notice.');
    })
    .catch(() => {
     setError('Error! Data could not be added, try again, avoid duplicate notice.');
    });
  }
 ...
 const handleSearch = (event) => {
  ...
  const searchUrl = new URL('https://sms-penetralia.azurewebsites.net/api/notice/search');
         ...
         <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
           ...
           {/* <div class="sidebar-menu-content">
             <ul class="nav nav-sidebar-menu sidebar-toggle-view">
               ...
               <li class="nav-item" style={{ backgroundColor: "black" }}>
                 <a href="/notice" class="nav-link menu-active">
             ...
             <div class="col-4-xxxl col-12">
               <div class="card height-auto">
                 <div class="card-body">
                   ...
                   <form class="new-added-form" onSubmit={SubmitNotice}>
                     <div class="row">
               ...
               <div class="card height-auto">
                 <div class="card-body">
                   ...
                   <div class="notice-board-wrap">
                     {searchActive ? (
                       // Render filteredNotices when a search is active
                       filteredNotices ? (
                         <div class="notice-list">
                           <div class="post-date bg-skyblue">
                             {filteredNotices.posted_date}
                           </div>
                           <h6 class="notice-title">
                             <a href="/#">{filteredNotices.details}</a>
                           </h6>
                           <div class="entry-meta">
                             {filteredNotices.posted_by} /{" "}
                             <span>{filteredNotices.notice_time}</span>
                           </div>
                         </div>
                       ) : (
                         <div
                     ...
                     ) : // Render notices when no search is active
                     Array.isArray(notices) && notices.length > 0 ? (
                       notices.map((notice) => (
                         <div class="notice-list" key={notice.id}>
                           <div class="post-date bg-skyblue">
                             {notice.posted_date}
                           </div>
                           <h6 class="notice-title">
                       ...
                       <div style={{ textAlign: "center" }} class="notice-list">
                         <div
                           style={{ textAlign: "center", color: "black" }}
                           class="post-date bg-skyblue"
                         >
                     ...
                     {/* <div class="notice-list">
                        ...
                        <h6 class="notice-title">
                          <a href="/#">
                            Great School Great School manag mene esom text of
                            the printing Great School manag mene esom text of
                            the printing manag mene esom text of the printing.
                          </a>
                        </h6>
                        <div class="entry-meta">
                          {" "}
