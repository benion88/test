...
const Messsage = () => {
 ...
 const SubmitMessage = (e) => {
  e.preventDefault();
  const messages = { to, message ,subject};
  const request = {
   'meta': {
    'action': '0',
    'source': 'web'
  ...
  if (authToken) {
   ...
   fetch(
    'https://sms-penetralia.azurewebsites.net/api/message/message_form',
    {
     method: 'POST',
     headers: {
    ...
    .then(() => {
     setSuccessMessage('Well done! You successfully send an Email.');
    })
    .catch(() => {
     setError('Error! email data could not be send. ');
    });
  }
 };
...
const isFormValid = () => {
  return message.trim() !== "" && subject.trim() !== "" && to.trim() !== "";
};
         ...
         <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
           ...
           {/* <div class="sidebar-menu-content">
             <ul class="nav nav-sidebar-menu sidebar-toggle-view">
               ...
               <li class="nav-item" style={{ backgroundColor: "black" }}>
                 <a href="/messaging" class="nav-link menu-active">
             ...
             <div class="col-xl-8">
               <div class="card">
                 <div class="card-body">
                   ...
                   <form class="new-added-form" onSubmit={SubmitMessage}>
                     <div class="row">
                 ...
                 <div class="card-body">
                   ...
                   <div class="message-success-box">
                     <div class="item-content">
                       ...
                       <h3 class="item-title">{successmessage}</h3>
                     </div>
                   </div>
                 </div>
               </div>
