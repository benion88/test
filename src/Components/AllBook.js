...
const AllBook = () => {
 ...
 useEffect(() => {
  ...
  if (authToken) {
   ...
   fetch('https://sms-penetralia.azurewebsites.net/api/library/library_list', {
    method: 'GET',
    headers: {
 ...
 const handleSearch = (event) => {
  ...
  const searchUrl = new URL('https://sms-penetralia.azurewebsites.net/api/library/search');
 ...
 const deleteUser = async (id) => {
  ...
  try {
   ...
   try {
    ...
    const response = await fetch(`https://sms-penetralia.azurewebsites.net/api/library/delete/${id}`, {
     method: 'DELETE',
     headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
             ...
             <ul class="nav nav-sidebar-menu sidebar-toggle-view">
               ...
               >
                 ...
                 <ul class="nav sub-group-menu sub-group-active">
                   <li class="nav-item">
                     <a href="/allBook" class="nav-link menu-active">
               ...
               <form class="mg-b-20">
                 <div class="row gutters-8">
                   ...
                   <div class="col-4-xxxl col-xl-4 col-lg-3 col-12 form-group">
                     <input
                       type="text"
                       placeholder="Search by Book_Name ..."
                       class="form-control"
                       onChange={(e) => {
                         setKeyword(e.target.value);
                       }}
                     ...
                     {searchActive ? (
                       ...
                       filteredBooks ? (
                         <tr>
                           ...
                           <td>{filteredBooks.book_name}</td>
                           <td>{filteredBooks.subject}</td>
                           <td>{filteredBooks.writter_name}</td>
                           <td>{filteredBooks.class_room}</td>
                           <td>{filteredBooks.publishing_date}</td>
                           <td>{filteredBooks.upload_date}</td>
                           <td>
                             <div class="dropdown">
                               <a
                                 href="/#"
