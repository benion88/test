  ...
  const fetchData = async () => {
   try {
    ...
    if (authToken) {
     ...
     const response = await fetch(`https://sms-penetralia.azurewebsites.net/api/teacher/teacher/${id}`, {
      method: 'GET',
      headers: {
                 ...
                 <div class="item-content">
                   <div class="header-inline item-header">
                     <h3 class="text-dark-medium font-medium">
                       {`Teacher Details for ${
                         teacherDetail && teacherDetail.first_name
                       } ${teacherDetail && teacherDetail.last_name}`}
                     </h3>
                       ...
                       <tbody>
                         <tr>
                           ...
                           <td class="font-medium text-dark-medium">
                             {teacherDetail.first_name}{" "}
                             {teacherDetail.last_name}
                           </td>
                         </tr>
                         <tr>
                           <td>Gender:</td>
