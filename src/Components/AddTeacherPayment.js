...
const AddTeacherPayment = () => {
 ...
 const SubmitTeacherPaymentForm = (e) =>{
  e.preventDefault();
  const teacherPayments = {first_name,last_name,gender,roll,email,class_room,status,phone,subject,amount,image_url};
  ...
  if (authToken) {
   ...
   fetch(
    'https://sms-penetralia.azurewebsites.net/api/teacher/teacher_payment_form',
    {
     method: 'POST',
     headers: {
    ...
    .then(() => {
     setMessage('Well done! You successfully add Teacher Payment.');
    })
    .catch(() => {
     setError('Error! Data could not be added, try again, avoid duplicate teacher payment record ');
    });
  }
       ...
       <div class="dashboard-page-one">
             ...
             <ul class="nav nav-sidebar-menu sidebar-toggle-view">
               ...
               >
                 ...
                 <ul class="nav sub-group-menu sub-group-active">
                   ...
                   <li className="nav-item">
                     <a href="/addTeacher" className="nav-link menu-active">
         ...
         <div class="dashboard-content-one">
           <div class="breadcrumbs-area">
             <h3>Teacher Payment</h3>
             <ul>
               <li>Add Teacher Payment</li>
               {message ? (
           ...
           <div class="card height-auto">
             <div class="card-body">
               ...
               <form class="new-added-form" onSubmit={SubmitTeacherPaymentForm}>
                 <div class="row">
