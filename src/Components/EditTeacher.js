   ...
   const fetchData = async () => {
     try {
       ...
       if (authToken) {
         ...
         const response = await fetch(
           `https://sms-penetralia.azurewebsites.net/api/teacher/teacher/${teacherId}`,
           {
             method: "GET",
             headers: {
               "Content-Type": "application/json",
    ...
    const UpdateTeacher = async (e) => {
      ...
      try {
        ...
        try {
          ...
          const response = await fetch(
            `https://sms-penetralia.azurewebsites.net/api/student/update/${teacherId}`,
            {
              method: "PUT",
              headers: {
                "Content-Type": "application/json",
          ...
          if (!response.ok) {
            ...
            setMessage(
              `User with ID ${teacherId} has been updated successfully.`
            );
        ...
        <div class="dashboard-page-one">
          ...
          <div class="dashboard-content-one">
            <div class="breadcrumbs-area">
              ...
              <ul>
                <li>
                  <a href="/allTeacher">Teacher List</a>
                </li>
                {message ? (
