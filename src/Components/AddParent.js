...
const AddParent = () => {
 ...
 const SubmitParentForm = (e) =>{
  e.preventDefault();
  const parents = {first_name,last_name,gender,occupation,id_no,blood_group,religion,email,phone,address,short_bio,image_url};
  console.log(parents);
  const request = {
  ...
  if (authToken) {
   ...
   fetch(
    'https://sms-penetralia.azurewebsites.net/api/parent/parent_form',
    {
     method: 'POST',
     headers: {
    ...
    .then(() => {
     setMessage('Well done! You successfully submitted a new Parent.');
    })
    .catch(() => {
     setError('Error! Data could not be added, try again, avoid duplicate Parent record');
    });
  }
             ...
             <ul class="nav nav-sidebar-menu sidebar-toggle-view">
               ...
               >
                 ...
                 <ul class="nav sub-group-menu sub-group-active">
                   ...
                   <li class="nav-item">
                     <a href="/addParent" class="nav-link menu-active">
         ...
         <div class="dashboard-content-one">
           ...
           <div class="card height-auto">
             <div class="card-body">
               ...
               <form class="new-added-form" onSubmit={SubmitParentForm}>
                 <div class="row">
                   ...
                   <div class="col-md-6 d-none d-xl-block"></div>
