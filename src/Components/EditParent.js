    ...
    const fetchData = async () => {
      try {
        ...
        if (authToken) {
          ...
          const response = await fetch(
            `https://sms-penetralia.azurewebsites.net/api/parent/parent/${parentId}`,
            {
              method: "GET",
              headers: {
                "Content-Type": "application/json",
 ...
 const UpdateParent = async (e) => {
   ...
   try {
     ...
     try {
       ...
       const response = await fetch(
         `https://sms-penetralia.azurewebsites.net/api/student/update/${parentId}`,
         {
           method: "PUT",
           headers: {
             "Content-Type": "application/json",
       ...
       if (!response.ok) {
         ...
         setMessage(`User with ID ${parentId} has been updated successfully.`);
        ...
        <div class="dashboard-page-one">
          ...
          <div class="dashboard-content-one">
            <div class="breadcrumbs-area">
              ...
              <ul>
                <li>
                  <a href="/allParent">Parent List</a>
                </li>
                {message ? (
