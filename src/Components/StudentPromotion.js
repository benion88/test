...
const StudentPromotion = () => {
 ...
 const [promote_session,setPromoteSession] = useState('');
 const [promotion_from_class,setPromotionFromClass] = useState('');
 const [promotion_to_class, setPromotionToClass] = useState('');
 ...
 const SubmitPromotionForm = (e) =>{
  e.preventDefault();
  const promotionForm = {full_name,current_session,promote_session,promotion_from_class,promotion_to_class};
  ...
  if(authToken){
   ...
   fetch(
    'https://sms-penetralia.azurewebsites.net/api/student/promotion',
    {
     method:'POST',
     headers:{
    ...
    .then(() => {
     setMessage('Well done! You successfully Promote a new student.');
    })
    .catch(() => {
     setError('Error! Student could not be promote, try again, avoid duplicate student ');
    });
  }
...
const isFormValid = () => {
  return (
    full_name.trim() !== "" &&
    current_session.trim() !== "" &&
    promote_session.trim() !== "" &&
    promotion_from_class.trim() !== "" &&
    promotion_to_class.trim() !== ""
  );
};
         ...
         <div className="dashboard-content-one">
           ...
           <div className="card height-auto">
             <div className="card-body">
               ...
               <form className="new-added-form" onSubmit={SubmitPromotionForm}>
                 <div className="row">
                   ...
                   <div className="col-xl-3 col-lg-6 col-12 form-group">
                     ...
                     <input
                       ...
                       placeholder="Nursery"
                       className="form-control"
                       value={promotion_from_class}
                       onChange={(e) => setPromotionFromClass(e.target.value)}
                     />
                   </div>
                   <div className="col-xl-3 col-lg-6 col-12 form-group">
                     ...
                     <input
                       ...
                       placeholder="Primary"
                       className="form-control"
                       value={promotion_to_class}
                       onChange={(e) => setPromotionToClass(e.target.value)}
                     />
                   </div>
