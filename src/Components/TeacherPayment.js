...
const [isParent, setIsParent] = useState(false);
 ...
 useEffect(() => {
  ...
  if (authToken) {
   ...
   fetch('https://sms-penetralia.azurewebsites.net/api/teacher/teacher_payment_list', {
    method: 'GET',
    headers: {
    ...
    .then(result => {
     ...
     if (result && result.data && Array.isArray(result.data)) {
      setTeacherPayments(result.data);
     } else {
 ...
 const handleSearch = (event) => {
  ...
  const searchUrl = new URL('https://sms-penetralia.azurewebsites.net/api/teacher/payment/search');
  ...
  fetch(searchUrl, {
   ...
   .then(result => {
    ...
    if (result && result.data) {
     setFilteredTeacherPayments(result.data);
     console.log(filteredTeacherPayments);
    } else {
     console.error('Invalid data structure:', result);
    }
   })
     ...
     <div id="wrapper" className="wrapper bg-ash">
       ...
       <div className="dashboard-page-one">
             ...
             <ul className="nav nav-sidebar-menu sidebar-toggle-view">
               ...
               >
                 ...
                 <ul className="nav sub-group-menu sub-group-active">
                   ...
                   <li className="nav-item">
                     <a href="/teacherPayment" className="nav-link menu-active">
                       <i className="fas fa-angle-right"></i>Teacher Payment
                     </a>
                   </li>
                   <li className="nav-item">
                   ...
                   <tbody>
                     {searchActive ? (
                       ...
                       filteredTeacherPayments ? (
                         <tr
                           onClick={() =>
                             navigate(`//${filteredTeacherPayments.id}`)
                           }
                         ...
                         >
                           ...
                           <td>
                             {filteredTeacherPayments.first_name}{" "}
                             {filteredTeacherPayments.last_name}
                           </td>
                           <td>{filteredTeacherPayments.gender}</td>
                           <td>{filteredTeacherPayments.class_room}</td>
                           <td>{filteredTeacherPayments.subject}</td>
                           <td>{filteredTeacherPayments.amount}</td>
                           <td
                             className={`badge badge-pill ${
                               filteredTeacherPayments.status === "paid"
                                 ? "badge-success"
                                 : "badge-danger"
                             } d-block
                                 mg-t-8`}
                           >
                             {filteredTeacherPayments.status}
                           </td>
                           <td>{filteredTeacherPayments.phone}</td>
                           <td>{filteredTeacherPayments.email}</td>
                           <td>
                             <div className="dropdown">
                               <a
                                 href="/#"
                         ...
                         <tr>
                           ...
                           >
                             No matching teacher payment found
                           </td>
                         </tr>
                       )
                     ) : Array.isArray(teacherPayments) &&
                       teacherPayments.length > 0 ? (
                       teacherPayments.map((teacherPayment) => (
                         <tr
                           key={teacherPayment.id}
                           onClick={() => navigate(`//${teacherPayment.id}`)}
                           style={{ cursor: "pointer" }}
                         >
                           <td>
                             <div className="form-check">
                           ...
                           <td>
                             {teacherPayment.first_name}{" "}
                             {teacherPayment.last_name}
                           </td>
                           <td>{teacherPayment.gender}</td>
                           <td>{teacherPayment.class_room}</td>
                           <td>{teacherPayment.subject}</td>
                           <td>{teacherPayment.amount}</td>
                           <td
                             className={`badge badge-pill ${
        ...
        mg-t-8`}
                           ...
                           <td>{teacherPayment.phone}</td>
                           <td>{teacherPayment.email}</td>
                           <td>
                             <div className="dropdown">
                               <a
                                 href="/#"
