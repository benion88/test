...
const [isParent, setIsParent] = useState(false);
 ...
 useEffect(() => {
  ...
  if (authToken) {
   ...
   fetch('https://sms-penetralia.azurewebsites.net/api/parent/parent_list', {
    method: 'GET',
    headers: {
 ...
 const handleSearch = (event) => {
  ...
  const searchUrl = new URL('https://sms-penetralia.azurewebsites.net/api/parent/search');
 ...
 const deleteParent = async (event,id) => {
  event.preventDefault();
  ...
  try {
   ...
   try {
    ...
    const response = await fetch(`https://sms-penetralia.azurewebsites.net/api/parent/delete/${id}`, {
     method: 'DELETE',
     headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json',
             ...
             <ul class="nav nav-sidebar-menu sidebar-toggle-view">
               ...
               >
                 ...
                 <ul class="nav sub-group-menu sub-group-active">
                   <li class="nav-item">
                     <a href="/allParent" class="nav-link menu-active">
                     ...
                     {searchActive ? (
                       ...
                       filteredParents ? (
                         <tr>
                           ...
                           <td>
                             {filteredParents.first_name}{" "}
                             {filteredParents.last_name}
                           </td>
                           <td>{filteredParents.gender}</td>
                           <td>{filteredParents.occupation}</td>
                           <td>{filteredParents.address}</td>
                           <td>{filteredParents.phone}</td>
                           <td>{filteredParents.email}</td>
                           <td>
                             <div class="dropdown">
                               <a
                                 href="/"
                               ...
                               <div class="dropdown-menu dropdown-menu-right">
                                 <div
                                   class="dropdown-item"
                                   onClick={(event) =>
                                     deleteParent(event, filteredParents.id)
                                   }
                                 >
                                 ...
                                 <a
                                   class="dropdown-item"
                                   href={`/edit-parent/${filteredParents.id}`}
                                 >
                       ...
                       parents.map((parent) => (
                         <tr
                           key={parent.id}
                           onClick={() =>
                             navigate(`/parentDetails/${parent.id}`)
                           }
