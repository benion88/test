...
const AddFeesCollection = () => {
 ...
 const [fees_date,setDate] = useState('');
 const [email,setEmail] = useState('');
 const [id_no, setIdNo] = useState('');
 const [fees, setFees] = useState('');
 const [gender,setGender] = useState('');
 const [class_room, setRoom] = useState('');
 const [school_section,setSection] = useState('');
 ...
 const SubmitFees = (e) =>{
  e.preventDefault();
  const data = {first_name,last_name,status,id_no,fees_date,expense_type,email,phone,amount,fees,gender,class_room,school_section,parent_email};
  const request = {
  ...
  if (authToken) {
   ...
   fetch(
    'https://sms-penetralia.azurewebsites.net/api/account/account_form',
    {
     method: 'POST',
     headers: {
    ...
    .then(() => {
     setMessage('Well done! You successfully submitted Account Record.');
    })
    .catch(() => {
     setError('Error! Data could not be added, try again, avoid duplicate Account Record  ');
    });
  }
             ...
             <ul class="nav nav-sidebar-menu sidebar-toggle-view">
               ...
               >
                 ...
                 <ul class="nav sub-group-menu sub-group-active">
                   ...
                   <li class="nav-item">
                     <a href="/addFees" class="nav-link menu-active">
                       <i class="fas fa-angle-right"></i>Add Fees Collection
                     </a>
                   </li>
                   <li class="nav-item">
                   ...
                   <li class="nav-item">
                     <a href="/addExpense" class="nav-link menu-active">
         ...
         <div class="dashboard-content-one">
           ...
           <div class="card height-auto">
             <div class="card-body">
               ...
               <form class="new-added-form" onSubmit={SubmitFees}>
                 <div class="row">
